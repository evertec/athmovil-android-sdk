...
public class ConstantUtil {
    ...
    public class BasicData{
        ...
        public final static String API_ROUTE_FINDPAYMENT_SERVICE = "api/business-transaction/ecommerce/business/findPayment";
    ...
    public class PaymentObject{
        ...
        public final static String PAYMENT_JSON_PAYMENT_I_D_KEY = "paymentId";
    ...
    public class ReturnedJson{
        ...
        public final static String RETURNED_JSON_PAYMENT_I_D_KEY = "paymentId";
