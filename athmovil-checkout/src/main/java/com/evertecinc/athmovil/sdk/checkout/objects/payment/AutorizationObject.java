...
public class AutorizationObject {
    ...
    public String ecommerceStatus;

    @SerializedName("referenceNumber")
    public String referenceNumber;

    @SerializedName("dailyTransactionId")
    public String dailyTransactionID;
    ...
    public AutorizationObject(String env, String pubToken, long timeout, Double total, Double tax, Double subtotal, String metadata1, String metadata2, List<Items> items, String phoNumber) {
        this.env = env;
        this.pubToken = pubToken;
        this.timeout = timeout;
        this.total = total;
