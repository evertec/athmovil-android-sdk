...
| `setMetadata1()` | String | Yes | Required variable that can be left empty or filled with additional transaction information. |
| `setMetadata2()` | String | Yes | Required variable that can be left empty or filled with additional transaction information. |
